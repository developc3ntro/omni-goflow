	...
	for _, dest := range destinations {
		...
		if a.Templating != nil {
			...
			if translation != nil {
				...
				templating = flows.NewMsgTemplating(a.Templating.Template, translation.Language(), translation.Country(), evaluatedVariables, translation.Namespace(), translation.MediaIds(), translation.Category(), translation.HasLTO(), translation.CouponCodeParamIndex())
			}
		}
